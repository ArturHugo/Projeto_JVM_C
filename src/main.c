...
int main(int numargs, char* arg[]) {
  /*
    if(numargs != 3) {
      printf("Número errado de argumentos. Faça ./output/main.exe -<flag> <nome do
  ...
  char descriptor[] = "(IDLjava/qualquercoisa;[[[ZIS)Ljava/lang/Object;";

  printf("O descritor %s tem %d arqumentos\n", descriptor, getArgumentCount((u1*) descriptor));
  return (0);
}
